                     ...
                     <div className="space-y-3 flex-1 relative z-10">
                        <div className="flex items-center justify-between p-4 rounded-xl bg-black/40 border border-white/5 hover:border-white/10 transition-colors">
                           ...
                           <button
                              ...
                              className="text-[13px] font-medium text-gray-400 hover:text-white transition-all duration-300 cursor-pointer hover:bg-white/5 px-3 py-1.5 rounded-lg active:scale-95"
                           >
                              Змінити
                           </button>
                        </div>
