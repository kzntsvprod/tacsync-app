...
import { SteamBindModal } from './SteamBindModal.jsx';
import {
   AlertCircle,
   Loader2,
   Lock,
...
export const AuthModal = ({ onClose, onSuccess }) => {
   ...
   const [isSteamBindOpen, setIsSteamBindOpen] = useState(false);
   ...
   return (
      <>
         ...
         <SteamBindModal
            isOpen={isSteamBindOpen}
            onClose={() => setIsSteamBindOpen(false)}
         />
      </>
   );
};
