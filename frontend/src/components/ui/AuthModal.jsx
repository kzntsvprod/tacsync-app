                  ...
                  <div className="animate-fade-in-up">
                     ...
                     >
                        ...
                        <button
                           type="submit"
                           disabled={isLoading}
                           className="w-full bg-white hover:bg-gray-200 active:scale-[0.98] text-black py-3 rounded-xl text-sm font-semibold transition-all duration-300 ease-in-out flex items-center justify-center gap-2 mt-2 disabled:opacity-70 disabled:active:scale-100 disabled:cursor-not-allowed"
                        >
                           {isLoading ? (
                     ...
                     <div className="mt-8">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                           <button className="col-span-2 justify-self-center group flex items-center justify-center gap-2 py-2.5 px-8 rounded-xl bg-[#0a0a0c] hover:bg-white/10 active:scale-[0.98] border border-white/5 hover:border-white/30 transition-all duration-300 text-sm font-medium text-gray-300 hover:text-white">
                              <SteamIcon className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors duration-300" />
                              Steam
                           </button>
                        </div>
                     </div>
                  ...
                  <div className="animate-fade-in-up">
                     ...
                     <form onSubmit={handleVerify} className="space-y-6">
                        ...
                        <div className="flex justify-between gap-2">
                           {otp.map((digit, index) => (
                              <input
                                 ...
                                 onPaste={handlePaste}
                                 className="w-12 h-14 bg-[#0a0a0c] border border-white/10 text-white rounded-xl text-center text-2xl font-medium focus:outline-none focus:border-white/50 focus:bg-white/[0.05] transition-all duration-300 shadow-inner [&:-webkit-autofill]:shadow-[0_0_0px_1000px_#0a0a0c_inset] [&:-webkit-autofill]:[-webkit-text-fill-color:white]"
                              />
                           ))}
                        </div>
                        ...
                        <button
                           type="submit"
                           disabled={isLoading}
                           className="w-full bg-white hover:bg-gray-200 active:scale-[0.98] text-black py-3 rounded-xl text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 disabled:active:scale-100 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(255,255,255,0.1)] mt-2"
                        >
                           {isLoading ? (
                              <Loader2 className="w-5 h-5 animate-spin" />
                           ) : (
